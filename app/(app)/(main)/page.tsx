            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-60 transition-opacity duration-700">
                  <div
                    className="absolute top-4 right-4 w-1 h-1 bg-accent rounded-full animate-ping"
                    style={{ animationDelay: "0s" }}
                  />
                  <div
                    className="absolute bottom-6 left-6 w-1.5 h-1.5 bg-primary rounded-full animate-pulse"
                    style={{ animationDelay: "0.5s" }}
                  />
                  <div
                    className="absolute top-1/3 right-1/3 w-0.5 h-0.5 bg-accent rounded-full animate-twinkle"
