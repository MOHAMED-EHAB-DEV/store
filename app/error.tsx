                    ...
                    {showDetails && (
                        <div className="px-6 pb-6 text-left">
                            <div className="p-4 bg-black/40 rounded-lg font-mono text-xs text-red-400/80 break-words overflow-auto max-h-60 border border-red-500/10">
                                <p className="mb-2 font-bold text-red-400 underline uppercase tracking-wider">Error Message:</p>
                                <p className="mb-4">{error.message}</p>
                                
                                {error.digest && (
                                    <>
                                        <p className="mb-2 font-bold text-red-400 underline uppercase tracking-wider">Error Digest:</p>
                                ...
                                {error.stack && (
                                    <>
                                        <p className="mb-2 font-bold text-red-400 underline uppercase tracking-wider">Stack Trace:</p>
