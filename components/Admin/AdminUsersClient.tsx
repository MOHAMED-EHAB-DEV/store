...
export default function AdminUsersClient({
    ...
    const handleChangeTier = async (tier: "free" | "premium") => {
        ...
        try {
            ...
            const data = await response.json();
            if (data.success) {
                sonnerToast.success(`${selectedIds.length} users updated to ${tier} tier`);
                setSelectedIds([]);
                router.refresh();
            } else {
            ...
            render: (user) => (
                <ActionDropdown
                    actions={createDefaultActions({
                        ...
                        onEdit: () => router.push(`/admin/users/edit/${user._id}`),
    ...
    return (
        <div className="p-6 space-y-8 animate-in fade-in duration-500">
            <PageHeader
                ...
                actions={
                    <Button onClick={() => router.push("/admin/users/new")} className="bg-primary hover:bg-primary/90">
            ...
            <div className="space-y-6">
                <SearchFilterBar
                    ...
                    onClearFilters={() => updateQuery({ role: "", tier: "", verified: "", search: "" })}
                />
