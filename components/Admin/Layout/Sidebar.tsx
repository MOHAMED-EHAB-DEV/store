        ...
        <div className="flex flex-col gap-1 md:mt-14 mt-10">
          {AdminSidebarLinks.map(({ Icon, text, link }, idx) => (
            <Button
              ...
              className={`w-full h-10 cursor-pointer transition-all px-5 py-3 rounded-md flex gap-3 items-center justify-start ${link === path ? "bg-white/10" : "hover:bg-white/10 bg-transparent"}`}
            >
