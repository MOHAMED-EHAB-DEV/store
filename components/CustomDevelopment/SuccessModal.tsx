...
const SuccessModal = ({ open, onOpenChange, ticketId }: SuccessModalProps) => {
  ...
  return (
    <Modal open={open} onOpenChange={onOpenChange}>
      <ModalContent
        size="7xl"
        className="p-0 border-white/10 bg-[#0f1015] rounded-2xl overflow-hidden focus:outline-none"
      >
        <div
          ref={contentRef}
          className="grid grid-cols-1 lg:grid-cols-2 min-h-[500px] max-h-[85vh] overflow-y-auto custom-scrollbar"
        ...
        >
          ...
          <div className="p-8 md:p-12 flex flex-col justify-center border-r border-white/10 bg-black/20">
            <div
              ref={checkRef}
              className="w-20 h-20 rounded-full bg-green-500/20 flex items-center justify-center mb-8 border border-green-500/30"
            >
              <span className="text-green-400 text-4xl">✓</span>
            </div>

            <h2 className="text-3xl font-bold mb-4 font-paras">
              Application Received
            </h2>
            <p className="text-gray-400 mb-6 text-lg">
              Your secure client workspace has been created and your project
              ticket is now open.
            </p>

            <div className="p-4 rounded-xl border border-purple-500/30 bg-purple-500/10 mb-8">
              <h4 className="text-purple-300 font-semibold mb-2">
                Next Step: Strategy Call
              </h4>
              <p className="text-sm text-gray-300">
                Book a quick 15-minute introductory call to go over your
                requirements, or skip directly to your chat dashboard to start
                messaging.
              </p>
            </div>
          ...
          <div className="p-8 md:p-12 flex flex-col bg-surface-dark">
            ...
            <div className="flex-1 flex flex-col items-center">
              ...
              {selectedDate && (
                <div className="w-full mt-2 animate-in fade-in slide-in-from-bottom-4 duration-300">
                  ...
                  <div
                    className="grid grid-cols-4 gap-2 max-h-[160px] overflow-y-auto custom-scrollbar pr-2"
                    data-lenis-prevent={true}
                  >
                    {TIME_SLOTS.map((time) => (
                      <button
