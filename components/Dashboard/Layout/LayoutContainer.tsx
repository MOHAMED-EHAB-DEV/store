...
const LayoutContainer = ({children, user}: Readonly<{children: React.ReactNode, user: IUser}>) => {
    ...
    return (
        <div className="lg:w-[calc(100%-18rem)] w-full ms-auto">
            <button
                className="lg:hidden p-1 bg-black border-b border-r border-t border-white rounded-tr-sm rounded-br-sm cursor-pointer absolute left-0 top-1/12 focus:outline-none focus:ring-2 focus:ring-white/20"
