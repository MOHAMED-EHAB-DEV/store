        ...
        >
            <div className="">
                <button
                    ...
                    className="bg-transparent cursor-pointer flex items-center justify-center lg:hidden rounded-full absolute top-2 end-2 p-4 focus:outline-none focus:ring-2 focus:ring-white/20"
                >
                    <X/>
                </button>
                ...
                <div className="flex flex-col gap-1 md:mt-14 mt-10">
                    {DashboardSidebarLinks.map(({Icon, text, link}, idx) => (
                        <button
                            ...
                            className={`w-full h-10 transition-all px-5 py-3 rounded-md flex gap-3 items-center text-left focus:outline-none focus:ring-2 focus:ring-white/20 ${path.includes(link) ? "bg-white/10" : "hover:bg-white/10"}`}
                        >
