  ...
  return (
    <>
      ...
      <Modal open={open} onOpenChange={setOpen}>
        <ModalContent className="border border-white/10 outline-none focus:outline-none focus:border-none bg-surface-dark text-white rounded-2xl max-w-md overflow-hidden p-6">
