...
export default function CategoryCarousel({
  ...
  return (
    <div className="relative mb-12">
      ...
      <div
        className="overflow-hidden md:overflow-visible px-4 md:px-0"
        ref={emblaRef}
      >
      ...
      <div
        aria-hidden="true"
        className="absolute top-0 bottom-0 left-0 w-8 bg-gradient-to-r from-abyss to-transparent pointer-events-none md:hidden"
      />
      <div
        aria-hidden="true"
        className="absolute top-0 bottom-0 right-0 w-8 bg-gradient-to-l from-abyss to-transparent pointer-events-none md:hidden"
      />
    </div>
  );
}
