...
const stats = [
    { label: "Templates Created", value: "50+", icon: Code },
        ...
        <div className="w-full max-w-7xl mx-auto px-4 py-16">
            ...
            <div className="text-center mb-16">
                ...
                <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto">
                    Passionate developer and designer creating premium templates that help businesses and creators build stunning digital experiences.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8">
                    ...
                    <div className="relative overflow-hidden rounded-3xl glass-strong p-8">
                        <div className="absolute inset-0 bg-gradient-to-br from-green-500/20 via-teal-500/20 to-cyan-500/20"></div>
                        
                        {/* Avatar */}
                        <div className="relative z-10 flex items-center gap-6 mb-6">
                            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-green-500 to-teal-500 flex items-center justify-center text-white text-2xl font-bold">
                                ME
                            </div>
                            <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {badges.map((badge, index) => {
                            ...
                            return (
                                ...
                                >
                                    <div className={`absolute inset-0 bg-gradient-to-br ${badge.gradient} opacity-10 group-hover:opacity-20 transition-opacity duration-300`}></div>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        {stats.map((stat, index) => {
                            ...
                            return (
                                ...
                                >
                                    <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-cyan-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                    <div className="relative z-10 text-center">
                    ...
                    <div className="relative overflow-hidden rounded-2xl glass-strong p-6">
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                <button className="flex-1 bg-gradient-to-r from-green-500 to-teal-500 text-white py-3 px-6 rounded-xl font-semibold hover:shadow-lg hover:shadow-green-500/25 transition-all duration-300">
                                    Browse Templates
                                </button>
                                <button className="flex-1 border border-white/20 text-white py-3 px-6 rounded-xl hover:bg-white/10 transition-colors duration-200">
                                    Get in Touch
                                </button>
                            </div>
                        </div>
