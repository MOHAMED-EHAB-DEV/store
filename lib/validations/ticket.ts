...
export const TicketSchema = v.object({
  ...
  category: v.union([v.literal("general"), v.literal("billing"), v.literal("technical"), v.literal("account"), v.literal("other"), v.literal("template-customization"), v.literal("custom-build")]),
